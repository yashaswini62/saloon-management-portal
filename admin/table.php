									...
									<!--sub-heard-part-->
									  <div class="sub-heard-part">
									   <ol class="breadcrumb m-b-0">
											...
											<li class="active">View Goggle's</li>
										</ol>
									   </div>
								  <!--//sub-heard-part-->
									<div class="graph-visual tables-main">
																...
																<h3 class="inner-tittle two">View Goggle's </h3>
														  <div class="graph">
															<div class="tables">
																...
																<?php
		$n=1;
	$p="SELECT * FROM package order by id desc";
		$result=select($p);
		...
		?>
          <tr data-expanded="true">
            <td><?=$n;?></td>
            <td><?=ucwords($titles);?></td>
            <td><?=$charge?> /-</td>
            
			<td><?=$description?></td>
            <td><a href="edit_package.php?id=<?=$ty['id']?>"><button class="btn btn-success">Edit</button></td>
            <td><a href="myphp.php?delete=yes&id=<?=$ty['id']?>"><button class="btn btn-danger">Delete</button></td>
           </tr>
          <?php
		$n++;
		}
